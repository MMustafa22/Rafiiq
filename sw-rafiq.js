...
const SW_VERSION   = '7.44.0';
const VERSION_HASH = 'rm-v120-20260919-hub-reorder-resize-tasks-49-random-v226'; // غيّر هذا عند كل تحديث
...
const STATIC_FILES = [
  ...
  // (v224) تسجيلات مستقلة مخصّصة لأذكار السبحة الإلكترونية فقط — منفصلة عن أذكار الصباح/المساء
  './audio/tasbih/subhanallah.mp3',
  './audio/tasbih/alhamdulillah.mp3',
  './audio/tasbih/allahu_akbar.mp3',
  './audio/tasbih/astaghfirullah.mp3',
  './audio/tasbih/la_hawla.mp3',
  './audio/tasbih/la_ilaha_illallah.mp3',
  './audio/tasbih/la_ilaha_illallah_wahdahu.mp3',
  './audio/tasbih/salah_annabi.mp3'
